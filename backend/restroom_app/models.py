...
class Restroom(models.Model):
    ...
    latitude = models.DecimalField(blank=False, null=False, max_digits=30, decimal_places=27)
    longitude  = models.DecimalField(blank=False, null=False, max_digits=30, decimal_places=27)
